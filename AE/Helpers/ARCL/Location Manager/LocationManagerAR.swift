...
protocol LocationManagerDelegate: class {
    func locationManagerDidUpdateLocation(_ locationManager: LocationManagerAR,
                                          location: CLLocation)
    func locationManagerDidUpdateHeading(_ locationManager: LocationManagerAR,
...
public class LocationManagerAR: NSObject {
...
extension LocationManagerAR: CLLocationManagerDelegate {
